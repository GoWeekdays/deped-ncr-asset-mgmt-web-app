<template>
  <v-row no-gutters justify="center">
    ...
    >
      <div
        v-if="isInventory"
        class="text-end font-weight-regular text-capitalize mb-2 font-times"
      ...
      <v-row class="mb-1" align="start" justify="start">
        <v-col cols="6" class="text-left">
          ...
          >
            Entity Name:
            <u class="th-11px font-times">{{ transferProperty.entityName }}</u>
          </div>
        </v-col>
        ...
        <v-col cols="6" class="text-left">
          ...
          >
            Fund Cluster:
            <u class="th-11px font-times">{{ transferProperty.fundCluster }}</u>
          </div>
        </v-col>
      </v-row>
        ...
        <thead>
          <tr>
            ...
            <th style="width: 30%; text-align: left; padding-left: 10px">
              <p v-if="isInventory" class="th-11px font-times">
                ITR No. {{ transferProperty.transferNo }}:
              </p>
              <p v-else class="th-11px font-times">
                PTR No. {{ transferProperty.transferNo }}:
              </p>
              <p class="th-11px font-times">
                Date:
                {{
                  transferProperty.createdAt
                    ? new Date(transferProperty.createdAt)
                        .toDateString()
                        .slice(4)
                    : ""
                }}
      ...
      <table style="border-collapse: collapse; width: 100%">
        <thead>
          <tr>
            <td
              class="th-11px font-times"
              style="text-align: left; border: none; padding-left: 20px"
            >
            ...
            <td style="text-align: left; border: none; padding-left: 200px">
              <label class="th-11px font-times">
                <input
                  ...
                  name="transferType"
                  value="donation"
                  :checked="transferProperty.transferType === 'donation'"
                  disabled
              ...
              <label class="th-11px font-times" style="margin-left: 20px">
                <input
                  ...
                  name="transferType"
                  value="relocate"
                  :checked="transferProperty.transferType === 'relocate'"
                  disabled
                  style="filter: grayscale(0) opacity(1)"
                />
                Relocate
            ...
            <td style="text-align: left; border: none; padding-left: 200px">
              <label class="th-11px font-times">
                <input
                  ...
                  name="transferType"
                  value="reassignment"
                  :checked="transferProperty.transferType === 'reassignment'"
                  disabled
                  style="filter: grayscale(0) opacity(1)"
                />
                Reassignment
              ...
              <label class="th-11px font-times" style="margin-left: 20px">
                <input
                  ...
                  value="others"
                  :checked="
                    !['donation', 'relocate', 'reassignment'].includes(
      ...
      <table border="1" style="border-collapse: collapse; width: 100%">
        <thead>
          <tr v-if="isInventory" class="font-weight-bold th-11px">
            ...
            <th
              rowspan="1"
              class="text-center custom-table-header"
              style="width: 10%"
            >
        ...
        <tbody v-if="isInventory">
          <tr
            v-for="(item, index) in transferProperty.itemStocks"
            :key="index"
          ...
          >
            ...
            <td class="th-12px">{{ item.name }} - {{ item.description }}</td>
        ...
        <thead>
          <tr class="th-11px">
            <th style="width: 100%; text-align: left; border: none">
              <p
                class="th-11px font-times th-reason-transfer"
                style="
                ...
                "
              >
                <span class="font-weight-bold th-11px font-times"
                  >Reason for Transfer:</span
                >
      ...
      >
        <thead>
          <tr class="th-11px">
            ...
            <th style="text-align: center; width: 25%; border: none">
              Approved by:
            </th>
            <th style="text-align: center; width: 25%; border: none">
              Release/Issued by:
        ...
        <tbody>
          <tr>
            <td
              class="text-11px font-times font-weight-bold"
              style="
                text-align: left;
                vertical-align: top;
                border: none;
          ...
          <tr>
            ...
            <td class="th-12px" style="border: none">
              {{ transferProperty.approvedByName }}
            </td>
            <td class="th-12px" style="border: none">
              {{ transferProperty.issuedByName }}
            </td>
            <td class="th-12px" style="border: none">
              {{ transferProperty.receivedByName }}
            </td>
          </tr>
          <tr class="text-capitalize">
            ...
            <td class="th-12px" style="border: none">
              {{ transferProperty.approvedByDesignation }}
            </td>
            <td class="th-12px" style="border: none">
              {{ transferProperty.issuedByDesignation }}
            </td>
            <td class="th-12px" style="border: none">
              {{ transferProperty.receivedByDesignation }}
            </td>
          </tr>
          <tr>
            <td
