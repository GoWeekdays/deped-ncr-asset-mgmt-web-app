<template>
  <v-row no-gutters justify="center">
    ...
    >
      <div
        class="text-end font-weight-regular text-capitalize mb-2 font-times th-12px"
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            <th
              colspan="6"
              class="text-center text-caption font-weight-regular"
              style="width: 12%; font-style: italic"
            >
          ...
          <tr>
            <th
              class="text-center th-8px custom-table-header"
              style="width: 12%"
            >
              RIS No.
            </th>
      ...
      <table border="1" style="border-collapse: collapse; width: 100%">
        <thead>
          <tr>
            <th
              colspan="3"
              style="text-align: start; width: 50%"
              class="font-weight-regular text-body-2 font-times"
            >
            ...
            <th
              colspan="3"
              style="text-align: start; width: 50%"
              class="font-times font-weight-regular text-body-2"
            >
              Posted by:
            </th>
          </tr>
        ...
        <tbody class="text-capitalize th-11px">
          <tr>
            <td colspan="3" style="border-top: hidden; text-align: center">
              ...
              <div
                class="text-primary-text text-center text-caption font-weight-regular font-times mt-3"
              >
                {{ admin }}
              </div>
              <span
