<template>
  <v-row no-gutters justify="center">
    ...
    >
      <div
        class="text-end font-weight-regular text-capitalize mb-5 font-times th-15px"
      ...
      >
        <thead>
          <tr>
            <td
              colspan="2"
              style="padding: 5px; text-align: left; border: none"
            >
                  ...
                  <u class="th-15px font-times">
                    {{
                      lostMaterial.issuedAt
                        ? new Date(lostMaterial.issuedAt)
                            .toDateString()
                            .slice(4)
                        : ""
                    }}
          ...
          <tr>
            ...
            >
              ...
              >
              <span
                class="th-15px font-times text-capitalize"
                style="border-bottom: 1px solid black; display: inline-block"
              >
      ...
      <table style="border-collapse: collapse; width: 100%">
        <thead>
          <tr>
            <td
              class="th-15px font-times"
              style="border: none; padding-bottom: 5px; text-align: start"
            >
            ...
            >
              ...
              >
                <input
                  ...
                  name="lossStatus"
                  value="lost"
                  :checked="lostMaterial.lossStatus === 'lost'"
                  disabled
                />
                Lost
              </label>
              ...
              >
                <input
                  ...
                  name="lossStatus"
                  value="damaged"
                  :checked="lostMaterial.lossStatus === 'damaged'"
                  disabled
                />
                Damaged
              </label>
            ...
            >
              ...
              >
                <input
                  ...
                  name="lossStatus"
                  value="stolen"
                  :checked="lostMaterial.lossStatus === 'stolen'"
                  disabled
                />
                Stolen
              </label>
              ...
              >
                <input
                  ...
                  name="lossStatus"
                  value="destroyed"
                  :checked="lostMaterial.lossStatus === 'destroyed'"
                  disabled
                />
                Destroyed
              </label>
      ...
      <table>
        <thead>
          <tr class="th-15px font-times font-weight-bold">
            ...
            <th class="th-15px font-times font-weight-bold">
              Acquisition Cost
            </th>
          </tr>
        </thead>
        <tbody>
          <tr
            v-for="(item, index) in [
              ...
              ...Array(
                Math.max(0, 7 - (lostMaterial.itemStocks?.length || 0))
              ).fill({}),
            ]"
            :key="index"
            style="border: none"
          ...
          <tr>
            <th style="text-align: left; padding-left: 10px">
              <div class="th-15px font-times font-weight-bold text-start">
                <p
                  class="th-15px font-times th-reason-transfer"
                  style="
                  ...
                  "
                >
                  <span class="font-weight-bold th-15px font-times">
                    Circumstances:
                  </span>
          ...
          <tr>
            ...
            >
              <p class="text-start th-15px font-times">
                I hereby certify that the item/s and circumstances stated above
                are true and correct.
              </p>

              <div style="text-align: center">
                <div style="margin-bottom: 8px" class="th-15px font-times mt-2">
                  {{ lostMaterial.officerName }}
                </div>
                <span
                  style="
                  ...
                  "
                  class="th-15px font-times"
                  >Signature over Printed Name of the Accountable Officer</span
                >
              </div>
              ...
              <p class="text-start th-15px font-times">
                ...
                <u class="th-15px font-times">{{
                  lostMaterial.governmentId
                }}</u>
              </p>
              <p class="text-start th-15px font-times">
                ID No. :
                <u class="th-15px font-times">{{
                  lostMaterial.governmentIdNo
                }}</u>
              </p>
              <p class="text-start th-15px font-times">
                Date Issued :
                <u class="th-15px font-times">{{
                  lostMaterial.governmentIdDate
                }}</u>
              </p>
            </td>
            <td
            ...
            >
              ...
              <div style="text-align: center">
                ...
                <span
                  ...
                  "
                  class="th-15px font-times"
                  >Signature over Printed Name of the Immediate Supervisor</span
                >
              </div>
        ...
        <thead>
          <tr style="border: none">
            <td colspan="2" style="padding: 5px; border: none">
              <p class="text-start th-15px font-times">
                <span class="th-15px font-weight-bold font-times"
                  >SUBSCRIBED AND SWORN</span
                >
                to before me this ______day of _____________, affiant exhibiting
