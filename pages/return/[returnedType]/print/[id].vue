    ...
    >
      ...
      <v-row dense class="mb-3" align="start" justify="start">
        <v-col cols="8" class="text-left">
          <div class="font-times">
            Entity Name:
            <span class="th-12px font-times font-weight-regular">{{
              returned.entityName
            }}</span>
          </div>
        </v-col>
      ...
      <table v-if="isReturnSEP">
        <thead class="custom-header-height font-times">
          <tr>
            <th class="text-center text-capitalize" style="width: 25%">
              Item Description
            </th>
            <th class="text-center text-capitalize" style="width: 10%">Qty</th>
            <th class="text-center text-capitalize" style="width: 15%">Unit</th>
            <th class="text-center text-capitalize" style="width: 20%">
              Ics No.
            </th>
            <th class="text-center text-capitalize" style="width: 15%">
              End User
            </th>
            <th class="text-center text-capitalize" style="width: 15%">
              Remarks
        ...
        <tbody>
          <tr
            v-for="(item, index) in [
              ...(returned.itemStocks?.filter((item) =>
...
const { returned, getReturnById, returnPrintTitle, isReturnPPE, isReturnSEP } =
  useReturn();
