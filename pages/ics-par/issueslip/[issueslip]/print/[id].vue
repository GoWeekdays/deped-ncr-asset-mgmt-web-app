<template>
  <v-row no-gutters justify="center">
    ...
    >
      ...
      <div
        class="text-center font-weight-bold text-capitalize mb-8 font-times"
        ...
        <v-col cols="6" class="text-left">
          <div class="font-times">
            ...
            <u class="th-12px font-times font-weight-regular">{{
              issueSlip.entityName
            }}</u>
          </div>
        </v-col>
        <v-col cols="6" class="text-left">
          <div class="font-times"></div>
        </v-col>
      ...
      <table v-if="isPAR">
        ...
        <tbody>
          <tr>
            <td class="custom-height th-12px" style="width: 10%">
              {{ issueSlip.quantity }}
            </td>
            <td class="custom-height th-12px" style="width: 15%">
              {{ issueSlip.unitOfMeasurement }}
            </td>
            <td class="custom-height th-12px" style="width: 25%">
              {{ issueSlip.name }} - {{ issueSlip.description }}
            </td>
            <td class="custom-height th-12px" style="width: 10%">
              {{ issueSlip.stockNumber }}
            </td>
      ...
      <table v-if="isICS" class="table table-bordered">
        <thead>
          <tr>
            <th rowspan="3" class="text-center th-9px text-capitalize">
              Quantity
            </th>
            <th rowspan="3" class="text-center th-9px text-capitalize">Unit</th>
            <th colspan="2" class="text-center th-9px text-capitalize">
              Amount
            </th>
            <th rowspan="3" class="text-center th-9px text-capitalize">
              Description
            ...
            <th rowspan="3" class="text-center th-8px custom-table-header">
        ...
        <tbody>
          <tr>
            ...
            <td class="th-9px">{{issueSlip.name}} - {{ issueSlip.description }}</td>
      ...
      <table border="1" style="border-collapse: collapse; width: 100%">
        <thead>
          <tr>
            <th colspan="3" style="text-align: start; width: 50%">
              Received By:
            </th>
            <th colspan="3" style="text-align: start; width: 50%">
              Issued By:
        ...
        <tbody class="text-capitalize th-11px">
          <tr>
            <td colspan="3" style="border-top: hidden; text-align: center">
              <div
                class="font-times font-weight-regular th-12px"
                style="margin-bottom: 8px"
              >
                {{ issueSlip.receivedByName }}
              </div>
              <span
                class="font-times font-weight-regular th-12px"
                style="
          ...
          <tr>
            <td colspan="3" style="border-top: hidden; text-align: center">
              <div
                ...
                style="margin-bottom: 8px"
              >
                {{ issueSlip.receivedByDesignation }}
              </div>
              <span
                class="font-times font-weight-regular th-12px"
                style="
